...
export const LoadingScreen = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black text-gray-300 flex flex-col items-center justify-center ">
      <div className="mb-4 text-3xl md:text-5xl lg:text-8xl font-bold font-sigmar bg-gradient-to-r from-blue-600 via-cyan-400 to-white leading-right bg-clip-text text-transparent ">
